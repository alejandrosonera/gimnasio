    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <a href="#" class="btn btn-primary ms-lg-3">Prueba Gratis</a>
            </div>
        </div>
    </nav>
    ...
    <section id="classes" class="section-padding bg-light">
        <div class="container">
            <div class="text-center mb-5">
                ...
                <p class="lead">Ofrecemos una amplia variedad de clases para todos los niveles y objetivos</p>
            </div>
            <div class="row g-4">
                <div class="col-md-6 col-lg-4">
                    <div class="card class-card shadow h-100">
                        <img src="/placeholder.svg?height=300&width=500" class="card-img-top" alt="Clase de CrossFit">
                        <div class="card-body">
                            <h5 class="card-title">CrossFit</h5>
                            <p class="card-text">Entrenamiento funcional de alta intensidad que combina levantamiento de pesas, ejercicios cardiovasculares y gimnásticos.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-clock me-2"></i>60 min</span>
                                <span><i class="bi bi-fire me-2"></i>Alta intensidad</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card class-card shadow h-100">
                        <img src="/placeholder.svg?height=300&width=500" class="card-img-top" alt="Clase de Yoga">
                        <div class="card-body">
                            <h5 class="card-title">Yoga</h5>
                            <p class="card-text">Mejora tu flexibilidad, fuerza y equilibrio mientras reduces el estrés con nuestras clases de yoga para todos los niveles.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-clock me-2"></i>45 min</span>
                                <span><i class="bi bi-fire me-2"></i>Baja intensidad</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card class-card shadow h-100">
                        <img src="/placeholder.svg?height=300&width=500" class="card-img-top" alt="Clase de Spinning">
                        <div class="card-body">
                            <h5 class="card-title">Spinning</h5>
                            <p class="card-text">Quema calorías y mejora tu resistencia cardiovascular con nuestras energéticas clases de ciclismo indoor.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-clock me-2"></i>45 min</span>
                                <span><i class="bi bi-fire me-2"></i>Media intensidad</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-lg-4">
                    <div class="card class-card shadow h-100">
                        <img src="/placeholder.svg?height=300&width=500" class="card-img-top" alt="Clase de Zumba">
                        <div class="card-body">
                            <h5 class="card-title">Zumba</h5>
                            <p class="card-text">Diviértete mientras quemas calorías con esta clase de baile que combina ritmos latinos y ejercicios aeróbicos.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-clock me-2"></i>50 min</span>
                                <span><i class="bi bi-fire me-2"></i>Media intensidad</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card class-card shadow h-100">
                        <img src="/placeholder.svg?height=300&width=500" class="card-img-top" alt="Clase de Boxeo">
                        <div class="card-body">
                            <h5 class="card-title">Boxeo</h5>
                            <p class="card-text">Aprende técnicas de boxeo mientras mejoras tu condición física, coordinación y liberas estrés.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-clock me-2"></i>60 min</span>
                                <span><i class="bi bi-fire me-2"></i>Alta intensidad</span>
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="card class-card shadow h-100">
                        <img src="/placeholder.svg?height=300&width=500" class="card-img-top" alt="Clase de Pilates">
                        <div class="card-body">
                            <h5 class="card-title">Pilates</h5>
                            <p class="card-text">Fortalece tu core, mejora tu postura y aumenta la flexibilidad con ejercicios controlados de bajo impacto.</p>
                            <div class="d-flex justify-content-between align-items-center">
                                <span><i class="bi bi-clock me-2"></i>45 min</span>
                                <span><i class="bi bi-fire me-2"></i>Baja intensidad</span>
                            </div>
            ...
            <div class="text-center mt-5">
                <a href="#" class="btn btn-primary">Ver Horario Completo</a>
            </div>
        </div>
    </section>
